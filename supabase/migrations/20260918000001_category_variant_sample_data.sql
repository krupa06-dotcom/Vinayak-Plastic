...
-- ============================================================
INSERT INTO category_variants (id, category_id, name, size, shape, color, capacity, material, price, is_active, display_order) VALUES
  -- Plastic Crates (crates)
  ('e1111111-1111-1111-1111-111111111101', 'c1111111-1111-1111-1111-111111111111', 'VPC-400', '400 × 300 × 130 mm', 'Rectangular', 'Blue, Grey', '15 kg', 'PP / HDPE', NULL, true, 1),
  ('e1111111-1111-1111-1111-111111111102', 'c1111111-1111-1111-1111-111111111111', 'VPC-500', '500 × 350 × 150 mm', 'Rectangular', 'Blue, Grey', '20 kg', 'PP / HDPE', NULL, true, 2),
  ('e1111111-1111-1111-1111-111111111103', 'c1111111-1111-1111-1111-111111111111', 'VPC-600', '600 × 400 × 200 mm', 'Rectangular', 'Blue, Green', '25 kg', 'HDPE', NULL, true, 3),
  ('e1111111-1111-1111-1111-111111111104', 'c1111111-1111-1111-1111-111111111111', 'VPC-650', '650 × 450 × 250 mm', 'Rectangular', 'Blue', '30 kg', 'HDPE', NULL, true, 4),
  ('e1111111-1111-1111-1111-111111111105', 'c1111111-1111-1111-1111-111111111111', 'VPC-700', '700 × 500 × 300 mm', 'Rectangular', 'Blue, Grey', '35 kg', 'HDPE', NULL, true, 5),

  -- Plastic Pallets
  ('e2222222-2222-2222-2222-222222222201', 'c2222222-2222-2222-2222-222222222222', 'VPP-1200', '1200 × 1000 × 150 mm', 'Single Face', 'Blue', '1500 kg', 'HDPE', NULL, true, 1),
  ('e2222222-2222-2222-2222-222222222202', 'c2222222-2222-2222-2222-222222222222', 'VPP-1100', '1100 × 1100 × 150 mm', 'Double Face', 'Grey', '1800 kg', 'HDPE', NULL, true, 2),
  ('e2222222-2222-2222-2222-222222222203', 'c2222222-2222-2222-2222-222222222222', 'VPP-1208', '1200 × 800 × 150 mm', 'Single Face', 'Blue', '1200 kg', 'HDPE', NULL, true, 3),
  ('e2222222-2222-2222-2222-222222222204', 'c2222222-2222-2222-2222-222222222222', 'VPP-NEST', '1200 × 1000 × 160 mm', 'Nestable', 'Grey', '2000 kg', 'HDPE', NULL, true, 4),

  -- Waste Bins
  ('e3333333-3333-3333-3333-333333333301', 'c3333333-3333-3333-3333-333333333333', 'VWB-120', '480 × 550 × 930 mm', 'Wheeled, Lidded', 'Green, Blue', '120 L', 'HDPE', NULL, true, 1),
  ('e3333333-3333-3333-3333-333333333302', 'c3333333-3333-3333-3333-333333333333', 'VWB-240', '580 × 740 × 1100 mm', 'Wheeled, Lidded', 'Green, Blue', '240 L', 'HDPE', NULL, true, 2),
  ('e3333333-3333-3333-3333-333333333303', 'c3333333-3333-3333-3333-333333333333', 'VWB-360', '620 × 860 × 1200 mm', 'Wheeled, Lidded', 'Green, Grey', '360 L', 'HDPE', NULL, true, 3),
  ('e3333333-3333-3333-3333-333333333304', 'c3333333-3333-3333-3333-333333333333', 'VWB-660', '800 × 1200 × 1350 mm', 'Wheeled, Lidded', 'Green, Blue', '660 L', 'HDPE', NULL, true, 4),

  -- Hand Pallet Trucks
  ('e4444444-4444-4444-4444-444444444401', 'c4444444-4444-4444-4444-444444444444', 'VPT-2500', '1150 × 550 × 1200 mm', 'Nylon Wheels', 'Red', '2500 kg', 'Steel', NULL, true, 1),
  ('e4444444-4444-4444-4444-444444444402', 'c4444444-4444-4444-4444-444444444444', 'VPT-3000', '1150 × 550 × 1200 mm', 'Nylon Wheels', 'Red', '3000 kg', 'Steel', NULL, true, 2),
  ('e4444444-4444-4444-4444-444444444403', 'c4444444-4444-4444-4444-444444444444', 'VPT-2500-PU', '1150 × 550 × 1200 mm', 'PU Wheels', 'Red', '2500 kg', 'Steel + PU', NULL, true, 3),
  ('e4444444-4444-4444-4444-444444444404', 'c4444444-4444-4444-4444-444444444444', 'VPT-3000-PU', '1150 × 550 × 1200 mm', 'PU Wheels', 'Red', '3000 kg', 'Steel + PU', NULL, true, 4)
